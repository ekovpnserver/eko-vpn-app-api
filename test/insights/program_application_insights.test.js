...
describe('Testing Application Insights by Program', () => {
  ...
  it('should return status code 200', (done) => {
    chai
      .request(app)
      .get('/api/v1/insight/application/program?program=all&filter=count')
  ...
  it('should return status code 200 for a data request', (done) => {
    chai
      .request(app)
      .get('/api/v1/insight/application/program?program=N-Teach&filter=data')
      .set('Authorization', 'Bearer ' + token)
      .end((err, res) => {
        if (err) {}
        res.should.have.status(200)
  ...
  it('should return status code 400 for a non filtered request', (done) => {
    chai
      .request(app)
      .get('/api/v1/insight/application/program')
      .set('Authorization', 'Bearer ' + token)
      .end((err, res) => {
        if (err) {}
